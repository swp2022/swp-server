...
public class BoardService {
	...
	@Transactional
	public List<BoardResponseDto> getBoardListByUserId(Integer userId, Integer size, Integer page) {
	...
	public List<BoardResponseDto> getMyBoardList(JwtUserDetails userDetails, Integer size, Integer page) {
		Pageable pageable = PageRequest.of(page, size);
		User user = userRepository.findByProviderAndProviderId(userDetails.getProvider(), userDetails.getUsername())
			.orElseThrow(() -> new UserNotFoundException("없는 유저입니다"));
	...
	@Transactional(readOnly = true)
	public List<BoardResponseDto> getFollowingUserBoard(JwtUserDetails userDetails, Integer size, Integer page) {
		Pageable pageable = PageRequest.of(page, size);
		User user = userRepository.findByProviderAndProviderId(userDetails.getProvider(), userDetails.getUsername())
			.orElseThrow(() -> new UserNotFoundException("없는 유저입니다"));
